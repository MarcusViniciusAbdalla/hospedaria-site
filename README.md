...
[![Mercado Pago](https://img.shields.io/badge/Mercado_Pago-Pix_SDK-009EE3?style=for-the-badge&logo=mercadopago&logoColor=white)](https://www.mercadopago.com.br/developers)
...
* **Mercado Pago SDK v2**: Integração nativa para emissão de cobranças Pix (`Copiar e Cola` e `QR Code Base64`) e consumo de Webhooks para atualização em tempo real do status das reservas.
...
Método,Rota,Descrição
GET,/api/admin/reservas,Lista todas as reservas ativas e bloqueios presenciais.
...
git clone [https://github.com/SeuUsuario/hospedaria-site.git](https://github.com/SeuUsuario/hospedaria-site.git)
cd hospedaria-site
